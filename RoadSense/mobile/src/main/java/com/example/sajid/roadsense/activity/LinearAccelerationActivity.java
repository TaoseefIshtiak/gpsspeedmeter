package com.example.sajid.roadsense.activity;
...
import com.example.sajid.roadsense.gauge.GaugeAcceleration;
import com.example.sajid.roadsense.gauge.GaugeRotation;
import com.example.sajid.roadsense.plot.DynamicPlot;
import com.example.sajid.roadsense.plot.PlotColor;
import com.example.sajid.roadsense.sensor.AccelerationSensor;
import com.example.sajid.roadsense.sensor.LinearAccelerationSensor;
import com.example.sajid.roadsense.sensor.observer.AccelerationSensorObserver;
import com.example.sajid.roadsense.sensor.observer.LinearAccelerationSensorObserver;
...
public class LinearAccelerationActivity extends Activity implements Runnable, View.OnTouchListener, LinearAccelerationSensorObserver, AccelerationSensorObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            SmartLocation.with(LinearAccelerationActivity.this).location()
        ...
        TextView accelerationLable = (TextView) findViewById(R.id.label_acceleration_name_0);
        accelerationLable.setText("Acceleration");

        TextView lpfLable = (TextView) findViewById(R.id.label_acceleration_name_1);
